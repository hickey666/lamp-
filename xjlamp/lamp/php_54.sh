...
sed -i /*data/d /xj/server/gd2/include/gd_io.h
sed -i '/gd_free/a\  void (*data);' /xj/server/gd2/include/gd_io.h


#install php
    tar -zxvf $lamp_dir/tools/php/php-5.4.29.tar.gz -C $lamp_dir/tools/php | tee /xj/server/log/install/php/php_tar.log
    cd $lamp_dir/tools/php/php-5.4.29/
...
\cp -f $lamp_dir/tools/php/php-5.4.29/php.ini-production /xj/server/php/etc/php.ini
