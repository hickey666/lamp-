...
#install php
    tar -zxvf $lamp_dir/tools/php/php-5.5.12.tar.gz -C $lamp_dir/tools/php | tee /xj/server/log/install/php/php_tar.log
...
\cp -f $lamp_dir/tools/php/php-5.5.12/php.ini-production /xj/server/php/etc/php.ini
